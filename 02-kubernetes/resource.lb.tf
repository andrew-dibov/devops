...
resource "yandex_lb_target_group" "lb__target_group_kubernetes_masters" {
  name      = var.lb__target_group_kubernetes_masters_name
  region_id = var.lb__target_group_kubernetes_masters_region_id
...
resource "yandex_lb_network_load_balancer" "lb__kubernetes_api" {
  ...
  attached_target_group {
    target_group_id = yandex_lb_target_group.lb__target_group_kubernetes_masters.id
